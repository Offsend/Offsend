...
final class AppCoordinator: ObservableObject {
    ...
    lazy var detector: SensitiveDataDetecting = RustPreferringDetector(aiDetector: aiModelRegistry)
    let riskEngine: RiskScoring = RustRiskScoringEngine()
    let maskingEngine: TextMasking = RustMaskingEngine()
    ...
    init() {
        ...
        do {
            store = try SecureLocalStore(maskingEngine: RustMaskingEngine())
            ...
            store = InMemoryLocalStore(maskingEngine: RustMaskingEngine())

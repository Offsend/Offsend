...
| [Configuration](configuration.md) | `.offsend.yml` — `check`, `hooks`, `context.mcp` / `subagents` / `history` |
...
2. Fix the boundary — `offsend protect`
3. Install gates — `offsend hook install`

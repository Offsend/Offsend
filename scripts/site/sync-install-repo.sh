#!/usr/bin/env bash
# Publishes scripts/cli/install.sh to the Offsend/install GitHub Pages repository.
set -euo pipefail

ROOT="$(cd "$(dirname "$0")/../.." && pwd)"
SOURCE_SCRIPT="${ROOT}/scripts/cli/install.sh"
SITE_TEMPLATE="${ROOT}/scripts/site/install.html"
